//
//  TinnitusEvalutaiontestlastViewController.swift
//  Audiometer
//
...
import Charts
import AgoraRtmKit
class TinnitusEvalutaiontestlastViewController: UIViewController, CallDelegate {
    ...
    ////Left Tone Residual Inhibitiona
    
    @IBOutlet weak var LeftToneNegativeNochange: UIButton!
    @IBOutlet weak var LeftToneNegativeChange: UIButton!
    @IBOutlet weak var LeftToneNegativeLouder: UIButton!
    @IBOutlet weak var LeftToneNegativeNoticable: UIButton!
    
    
    ///Right Noise Residual Inhibitation
    
    @IBOutlet weak var RightNoiseNoChange: UIButton!
    @IBOutlet weak var RightNoiseChnage: UIButton!
    @IBOutlet weak var RightNoiseLauder: UIButton!
    @IBOutlet weak var RightNoiseNoticable: UIButton!
    ...
    @IBAction func LeftToneNegativeClick(_ sender: UIButton) {
        
        if sender.currentTitle == "NoChange"
        {
            LeftToneNegativeNochange.setImage(UIImage(named: "01"), for: .normal)
            LeftToneNegativeChange.setImage(UIImage(named: "02"), for: .normal)
            LeftToneNegativeLouder.setImage(UIImage(named: "02"), for: .normal)
            LeftToneNegativeNoticable.setImage(UIImage(named: "02"), for: .normal)
        }
        else if sender.currentTitle == "Changed"
        {
            LeftToneNegativeNochange.setImage(UIImage(named: "02"), for: .normal)
            LeftToneNegativeChange.setImage(UIImage(named: "01"), for: .normal)
            LeftToneNegativeLouder.setImage(UIImage(named: "02"), for: .normal)
            LeftToneNegativeNoticable.setImage(UIImage(named: "02"), for: .normal)
        }
        else if sender.currentTitle == "Louder"
        {
            LeftToneNegativeNochange.setImage(UIImage(named: "02"), for: .normal)
            LeftToneNegativeChange.setImage(UIImage(named: "02"), for: .normal)
            LeftToneNegativeLouder.setImage(UIImage(named: "01"), for: .normal)
            LeftToneNegativeNoticable.setImage(UIImage(named: "02"), for: .normal)
        }
        else if sender.currentTitle == "Noticeable"
        {
            LeftToneNegativeNochange.setImage(UIImage(named: "02"), for: .normal)
            LeftToneNegativeChange.setImage(UIImage(named: "02"), for: .normal)
            LeftToneNegativeLouder.setImage(UIImage(named: "02"), for: .normal)
            LeftToneNegativeNoticable.setImage(UIImage(named: "01"), for: .normal)
        }
        
    }
    
    @IBAction func RightNoiseNoticableClick(_ sender: UIButton) {
        if sender.currentTitle == "NoChange"
           {
               RightNoiseNoChange.setImage(UIImage(named: "01"), for: .normal)
               RightNoiseChnage.setImage(UIImage(named: "02"), for: .normal)
               RightNoiseLauder.setImage(UIImage(named: "02"), for: .normal)
               RightNoiseNoticable.setImage(UIImage(named: "02"), for: .normal)
           }
           else if sender.currentTitle == "Changed"
           {
               RightNoiseNoChange.setImage(UIImage(named: "02"), for: .normal)
               RightNoiseChnage.setImage(UIImage(named: "01"), for: .normal)
               RightNoiseLauder.setImage(UIImage(named: "02"), for: .normal)
               RightNoiseNoticable.setImage(UIImage(named: "02"), for: .normal)
           }
           else if sender.currentTitle == "Louder"
           {
               RightNoiseNoChange.setImage(UIImage(named: "02"), for: .normal)
               RightNoiseChnage.setImage(UIImage(named: "02"), for: .normal)
               RightNoiseLauder.setImage(UIImage(named: "01"), for: .normal)
               RightNoiseNoticable.setImage(UIImage(named: "02"), for: .normal)
           }
           else if sender.currentTitle == "Noticeable"
           {
               ...
               RightNoiseChnage.setImage(UIImage(named: "02"), for: .normal)
               RightNoiseLauder.setImage(UIImage(named: "02"), for: .normal)
               RightNoiseNoticable.setImage(UIImage(named: "01"), for: .normal)
           }
    }
    
    @IBAction func SaveBtnClciked(_ sender: Any) {
        
        var Navigation = self.storyboard?.instantiateViewController(withIdentifier: "TinnitusResultViewController") as! TinnitusResultViewController
