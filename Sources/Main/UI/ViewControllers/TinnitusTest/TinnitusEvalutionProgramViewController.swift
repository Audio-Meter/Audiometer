//
//  TinnitusEvalutionProgramViewController.swift
//  Audiometer
//
//  Created by Dogra Tech on 04/03/20.
...
import Charts
import AgoraRtmKit
class TinnitusEvalutionProgramViewController: UIViewController, CallDelegate {
    ...
    @IBAction func SaveBtnClicked(_ sender: Any) {
        ...
        var Navigation = self.storyboard?.instantiateViewController(withIdentifier: "TinnitusTestEvalutionProgramToneTestingViewController") as! TinnitusTestEvalutionProgramToneTestingViewController
